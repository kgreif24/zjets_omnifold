...
parser.add_argument(
    "--weight_card", type=str, help="Path containing wildcard for Omnifold weights"
)
parser.add_argument(
    "--err_multiple", type=float, default=1.0, help="Error multiple for plotting"
)
parser.add_argument(
    "--compare",
    type=str,
...
f_truthpd = uproot.open(
    "./dataloc/WithTracks_TruthPseudodata_Mar12_Combined_1_50_Top_shuffled.root"
)
