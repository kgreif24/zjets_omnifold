...
def test_omnifold(tmp_path):
    ...
    assert (tmp_path / 'test-of' / 'test-of-run_1' / 'weights' / 'iteration_0_step_1.npz').exists()
    assert (tmp_path / 'test-of' / 'test-of-run_1' / 'weights' / 'iteration_0_step_2.npz').exists()
    assert (tmp_path / 'test-of' / 'test-of-run_1' / 'weights' / 'iteration_1_step_1.npz').exists()
    ...
    i0s1 = np.load(tmp_path / 'test-of' / 'test-of-run_1' / 'weights' / 'iteration_0_step_1.npz')
    ...
    i0s2 = np.load(tmp_path / 'test-of' / 'test-of-run_1' / 'weights' / 'iteration_0_step_2.npz')
    ...
    assert np.all(test_weights[truth_p190 == 1] == expected_net_weights * mc_test_weights[mc_test_truth_p190 == 1])
    assert np.all(test_weights[truth_p190 == 0] == mc_test_weights[mc_test_truth_p190 == 0])

    # Check that the i1s1 weights are correct
    i1s1 = np.load(tmp_path / 'test-of' / 'test-of-run_1' / 'weights' / 'iteration_1_step_1.npz')
    ...
    assert np.all(test_weights[p190 == 1] == expected_net_weights * i0s2['test'][mc_test_p190 == 1])
    assert np.all(test_weights[p190 == 0] == i0s2['test'][mc_test_p190 == 0])

    # Check that the i1s2 weights are correct
    i1s2 = np.load(tmp_path / 'test-of' / 'test-of-run_1' / 'weights' / 'iteration_1_step_2.npz')
    ...
    assert np.all(test_weights[truth_p190 == 1] == expected_net_weights * i0s2['test'][mc_test_truth_p190 == 1])
    assert np.all(test_weights[truth_p190 == 0] == i0s2['test'][mc_test_truth_p190 == 0])
